...
from src.dagr.utils.args import FLAGS
...
class YOLOXHead(M.Module):
    ...
    def get_losses(
        ...
        if arg.no_cls:
            #debug cls type:
            print("===== Debugging loss_cls =====")
            print("Type of loss_cls:", type(loss_cls))
            # If it's a tensor, print its shape and device
            if hasattr(loss_cls, 'shape'):
                print("Shape of loss_cls:", loss_cls.shape)
            if hasattr(loss_cls, 'device'):
                print("Device of loss_cls:", loss_cls.device)
            # Print the first few elements to inspect values
            if hasattr(loss_cls, 'detach'):
                print("Sample values of loss_cls:", loss_cls.detach().cpu().numpy()[:10])
            print("==============================")
